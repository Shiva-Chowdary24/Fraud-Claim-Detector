          ...
          <div className="max-w-6xl mx-auto">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {policies.map((p) => (
                  <div key={p.id} className="bg-[#111e32]/60 backdrop-blur-md border border-slate-800 p-8 rounded-[2rem] shadow-2xl flex flex-col h-full hover:border-blue-500/50 transition-all group">
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex justify-center items-center p-6">
          ...
          <div className="bg-[#0f172a] border border-slate-800 w-full max-w-lg rounded-[2rem] p-8 relative shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="bg-black w-12 h-12 flex items-center justify-center rounded-xl border border-slate-700 shadow-inner">
